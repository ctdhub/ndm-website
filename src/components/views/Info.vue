<template>
  <div class="section-1">
    ...
    <span style="color: white; padding: 2rem; z-index: 2"
      >Welcome To New Destiny Ministries! Thank you for scanning the QR Code.
      Click the links below:</span
    >
  </div>
  <div class="section-2">
    <div class="sub-section">
      <button class="btn b-main" @click="navigateToLink('giving')">
        <span style="margin-right: 10px">Giving</span>
